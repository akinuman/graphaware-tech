/**
 * A copy of Sigma.js WebGL Abstract Node Program to be modified
 * =====================================
 *
 * @module
 */
import { AbstractProgram, IProgram, RenderParams } from "sigma/rendering/webgl/programs/common/program";
